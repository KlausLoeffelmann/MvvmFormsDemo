...
Partial Class Form1
    ...
    Private Sub InitializeComponent()
        ...
        MvvmDataGrid1_IDColumn.DataSourceType = GetType(MvvmFormsDemoViewModelLib.ContactViewModel)
        ...
        MvvmDataGrid1_FirstnameColumn.DataSourceType = GetType(MvvmFormsDemoViewModelLib.ContactViewModel)
        ...
        MvvmDataGrid1_LastnameColumn.DataSourceType = GetType(MvvmFormsDemoViewModelLib.ContactViewModel)
        ...
        MvvmDataGrid1_DateOfBirthColumn.DataSourceType = GetType(MvvmFormsDemoViewModelLib.ContactViewModel)
        ...
        Me.MvvmDataGrid1.DataSourceType = GetType(MvvmFormsDemoViewModelLib.ContactViewModel)
